...
export const BADGES: BadgeDef[] = [
  ...
  { id: "mess", label: "MESS REGULAR", hint: "Reach 50 on 21G FOOD", earned: (s) => s.axes.eat >= 50 },
  { id: "tamil", label: "STREET TAMIL", hint: "Reach 20 on 5C TAMIL", earned: (s) => s.axes.speak >= 20 },
  { id: "meter", label: "METER MASTER", hint: "Reach 50 on 23C TRAVEL", earned: (s) => s.axes.move >= 50 },
  ...
  { id: "foodmap", label: "FOOD MAP", hint: "Reach 100 on 21G FOOD", earned: (s) => s.axes.eat >= 100 },
  { id: "fluent", label: "FLUENT", hint: "Reach 50 on 5C TAMIL", earned: (s) => s.axes.speak >= 50 },
  { id: "settled", label: "SETTLED IN", hint: "Reach 25 on 29C SERVICES", earned: (s) => s.axes.live >= 25 },
